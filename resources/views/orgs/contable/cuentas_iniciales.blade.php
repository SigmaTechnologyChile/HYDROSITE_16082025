@extends('layouts.nice', ['active' => 'cuentas-iniciales', 'title' => 'Configuración de Cuentas Iniciales'])
...
<div class="contable-container">
    ...
    <nav class="contable-breadcrumb">
        <a href="{{ route('orgs.dashboard', ['id' => $id ?? 864]) }}" class="contable-breadcrumb-item">
    ...
    <div class="contable-section">
        <div class="contable-header">
            <div>
                ...
                <p class="contable-subtitle">Configure los saldos iniciales para comenzar con la gestión contable</p>
            </div>
        </div>

        <div class="contable-body contable-text-center">
            <!-- Alerta informativa -->
            <div class="contable-alert contable-alert-info contable-mb-xl">
                <i class="bi bi-info-circle"></i>
                <div>
                    <p><strong>Información importante:</strong> Esta configuración establecerá los saldos base para todos los reportes y cálculos contables del sistema.</p>
                </div>
            </div>
            
            <!-- Botón principal modernizado -->
            <button id="cuentasInicialesBtn" class="contable-btn contable-btn-primary contable-btn-lg">
                <i class="bi bi-journal-plus"></i> 
                Configurar Cuentas Iniciales
            </button>
        </div>
    </div>
</div>

{{-- Incluir nuestro modal modernizado --}}
@include('orgs.contable.partials.contable-styles')
