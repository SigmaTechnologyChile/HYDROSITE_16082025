...

{
    ...
    // Guardar lectura
    public function guardar(\Illuminate\Http\Request $request, $orgId)
    {
    ...
    // Listar lecturas
    public function listar(\Illuminate\Http\Request $request, $orgId)
    {
        $query = \App\Models\MacromedidorReading::where('org_id', $orgId);
